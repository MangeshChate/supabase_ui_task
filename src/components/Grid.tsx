            ...
            <div className='grid grid-cols-4 container gap-5'>
                <Card className="col-span-2 p-10 justify-between flex border-slate-700">
                    ...
                    <div className="flex flex-1 justify-center items-center">
                        <img src="https://framerusercontent.com/images/2QGo7WAFtRWGx50S0mp0R1TSY0.png" alt="Database Image" className='object-cover w-[200px] h-[200px]' />
                    </div>
                </Card>
                <div className="grid grid-cols-2 col-span-2 gap-5">
                    <Card className='col-span-1 flex-col flex border-slate-700 justify-center items-center'>
                        ...
                        <div className='flex justify-center w-full items-center m-5'>
                            <img src="https://pngpix.com/images/hd/abstract-geometric-complexity-kdmc0bebazzibefg.jpg" alt="Authentication Image" className='w-[150px]' />
                        </div>
                    </Card>
                    <Card className='col-span-1 flex-col flex border-slate-700 items-center relative'>
                        ...
                        <div className='flex w-full items-center m-5 absolute bottom-0'>
                            <img src="https://static.wixstatic.com/media/4a2cf0_1dc96638cf60488aaabb928c8a2751ca~mv2.png/v1/crop/x_0,y_158,w_1200,h_1032/fill/w_1116,h_960,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/%E2%80%94Pngtree%E2%80%94abstract%20wave%20dot%20blue%20_5505168.png" alt="Edge Function Image" className='w-full h-auto' />
                        </div>
                    </Card>
                </div>
            </div>
